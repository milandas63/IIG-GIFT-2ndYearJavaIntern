  ...
  public class Start extends JFrame {
	...
	public Start() {
		...
		this.setJMenuBar(mbar);
			...
			mbar.add(mnuMaster);
				...
				JMenuItem mnuCompany = new JMenuItem("Company");
	...
	private JPanel buttonPanel() {
		...
		btnCompany.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent ae) {
				JInternalFrame iCompany = new JInternalFrame("Company");
				iCompany.setLayout(new BorderLayout(5,5));
				iCompany.setResizable(true);
				iCompany.setClosable(true);
				iCompany.setIconifiable(true);
				iCompany.setMaximizable(true);

				JPanel pnlBottom = new JPanel(new GridLayout(1,6));
				iCompany.add(pnlBottom, BorderLayout.SOUTH);
				JButton btnAdd = new JButton("Add");
				JButton btnEdit = new JButton("Edit");
				JButton btnDelete = new JButton("Delete");
				JButton btnSearch = new JButton("Search");
				...
				desktop.add(iCompany);
				iCompany.setBounds(0,0,800,450);
				iCompany.setVisible(true);
			}
		});
		...
		btnActivity.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent ae) {
				JInternalFrame iActivity = new JInternalFrame("activity");
				...
				iActivity.setBounds(0,0,800,450);
